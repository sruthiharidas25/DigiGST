...
window.NoticeDrafterPage = function NoticeDrafterPage({goNav}){
  ...
  function loadSampleData(){
    if(formType === "DRC-01B"){
      ...
      setVarianceAmt(215000);
      setReasonCode("C3");
      setExplanation("The excess ITC of ₹2,15,000 relates to invoices from TechParts India Ltd (4 invoices, ~₹1,45,600) and Mumbai Logistics Co (5 invoices, ~₹62,300). Both suppliers filed their GSTR-1 returns late — these invoices have subsequently reflected in March 2B.");
      setPaidPortion(0);
    }
  }
  ...
  async function generateDraft(){
    ...
    const prompt = `You are drafting a formal Part B reply to a ${formType} intimation under Rule ${formType==="DRC-01B"?"88C":"88D"} of the CGST Rules, 2017, on behalf of Acme Enterprises Pvt. Ltd. (GSTIN 27AABCU9603R1ZX).
...
- Pending IMS: TechParts (4 invoices), Mumbai Logistics (5 invoices)
...
7. Sign-off: "Authorised Signatory, Acme Enterprises Pvt. Ltd." with date and place
...
Taxpayer: Acme Enterprises Pvt. Ltd.
